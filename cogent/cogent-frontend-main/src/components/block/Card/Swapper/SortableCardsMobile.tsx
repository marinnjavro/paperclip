...
import SortableItem from '@/components/block/Card/Swapper/SortableItem'
import Item from '@/components/block/Card/Swapper/Item'
...
// TODO fix items type
const SortableCardsMobile: FC<SortableProps> = ({ items, updateOrder }) => {
...
export default SortableCardsMobile
