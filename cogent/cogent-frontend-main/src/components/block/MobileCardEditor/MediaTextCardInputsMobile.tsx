...
interface MediaTextInputsMobileProps {
  card: Card
...
const MediaTextCardInputsMobile: React.FC<MediaTextInputsMobileProps> = ({
  card,
  updateMobileCard,
  updateCardPhoto,
  updateCardVideo,
...
export default MediaTextCardInputsMobile
function updateCardVideo(cardInput: CardInputType, files: FileList) {
